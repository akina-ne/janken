...
public class JankenAuthConfiguration {
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    UserDetails ほんだ = User.withUsername("ほんだ")
        .password("{bcrypt}$2y$05$Fo5JlDMwdpZ4VDFUHDjpU.pgvfXib1Ccq1MgKHdcdxHA07NxiDTTu").roles("USER").build();
    UserDetails いがき = User.withUsername("いがき")
        .password("{bcrypt}$2y$05$KsWFvfXBDpUkEihfRVnBI..OCfw60TjKOUC1jMueT0AsWHTxK9tgO").roles("USER").build();
